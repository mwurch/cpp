...
AForm::NotSignedException::NotSignedException() : invalid_argument("Default Exception") {}

AForm::NotSignedException::NotSignedException(const char *message) : invalid_argument(message) {}
